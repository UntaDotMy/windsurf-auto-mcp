...
```text
When you complete a task, you MUST call WindsurfAutoMcp to ask whether to continue. No exceptions: you must wait for the user’s response and must not terminate early.
